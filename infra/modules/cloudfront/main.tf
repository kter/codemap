locals {
  ...
  # Strip https:// prefix from API GW endpoint to get the hostname
  apigw_hostname = replace(replace(var.api_gateway_endpoint_url, "https://", ""), "http://", "")
}
...
resource "aws_cloudfront_distribution" "main" {
  ...
  origin {
    domain_name = local.apigw_hostname
